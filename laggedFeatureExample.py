...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.20, shuffle=False, random_state=42, stratify=None)


# Testing with two different models, Lightgbm and Random Forest. Both performing well
model = lgb.LGBMRegressor()
model.fit(X_train, y_train)
predictions = model.predict(X_test)

rf = RandomForestRegressor(n_estimators=100, max_depth=10, random_state=0, min_samples_split=5, min_samples_leaf=5)
